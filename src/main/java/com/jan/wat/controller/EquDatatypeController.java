...
public class EquDatatypeController {
    ...
    public Page<EquDatatype> getAllEquDatatypePage(@PathVariable long current, @PathVariable long size)
    {
        Page<EquDatatype> page = new Page<>(current, size);
        return iEquDatatypeService.page(page);
    }
